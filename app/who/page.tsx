...
export default function WhoPage() {
  return (
    <div>
      ...
      <p>Prior to going solo, my design career began its infancy, when Macromedia was still a household name and Web 2.0 was hitting it&apos;s bubbly prime. I started as a web designer at an online travel operator called Tourico Holidays (now HotelBeds) and this is where I first clapped eyes on naked HTML & CSS. We had dedicated developers to write all the code, but started learning and practicing to satisfy my curiosity. But it wasn't until my first year working at Spatial Networks that I would feel the power of <code className="text-xl p-2 bg-neutral-100 rounded-md border border-dashed border-neutral-300">git push origin master</code>.</p>
