      ...
      <div className="container-wide px-4 sm:px-6 md:px-8 xl:px-0 py-48">
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-24">
          <ul className="rounded-md border border-[var(--color-border)] w-full md:w-fit flex flex-col gap-1 md:gap-0 md:flex-row mt-12 !mb-0 text-base">
            ...
            <li>
              <Link href="https://github.com/campbell17" target="_blank" rel="noopener noreferrer" className="w-full p-6 py-4 flex items-center transition-colors">
            ...
            <li>
              <Link href="https://linkedin.com/in/campbell17" target="_blank" rel="noopener noreferrer" className="w-full p-6 py-4 flex items-center transition-colors">
        ...
        <ul className="space-y-4 list-disc list-outside ml-5">
          ...
          <li>
            I write for fun, mostly about the psychology behind making progress. You can read what I publish on <Link href="https://campbellseventeen.substack.com" target="_blank" rel="noopener noreferrer" className="text-teal-600">Substack</Link>.
          </li>
          <li>
