...
const SpatialNetworksContent: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Stats Callout */}
      <div className="w-full bg-green-50 pt-12 pb-16 px-20 border-y border-green-100">
        <div className="w-full 2xl:max-w-7xl mx-auto">
          ...
          <div>
            <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3 font-sans">
              {stats.map((item) => (
                <div key={item.name} className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow shadow-green-200/50 sm:p-6">
