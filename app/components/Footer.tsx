            ...
            <div className="flex flex-col space-y-8">
              ...
              <div className="flex space-x-4">
                ...
                <Link 
                  ...
                  rel="me" 
                  className="h-8 w-8 group text-black hover:text-[var(--mode-color)] rounded-full bg-[var(--color-link)] flex items-center justify-center hover:bg-[var(--color-link-hover)] transition-color duration-150"
                >
