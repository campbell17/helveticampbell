...
const tags = ["Branding", "Product Design", "Marketing Design"];
const description = "Spatial Networks project work.";
const coverImage = "/images/work/index/work-index-spatial-networks.jpg";
const heading = "Spatial Networks";
const headingAlt = "Geospatial Solutions";
const subheading = "Geospatial solutions and mapping technologies.";

export default function SpatialNetworksPage() {
  return (
    <div className="project-page">
      {/* Spatial Networks page content inlined from SpatialNetworksContent component */}
        ...
        <div className="max-w-none">
          ...
          <div className="mb-4 lg:mb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
              {
                images.slice(4, 16).map((image, index) => (
